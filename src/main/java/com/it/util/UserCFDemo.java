...
public class UserCFDemo{
    ...
    //和这些用户相关的对象
    public static String[] movies={"对象1","对象2","对象3","对象4","对象5","对象6","对象7"};
    //用户点评对象打星数据,是users对应用户针对movies对应对象的评分
...
//    	System.out.println("realname=="+realname);
    ...
    private static void calcRecommendMovie(){
        ...
        for (List<Object> item:recommendMovies){
            if(Double.parseDouble(item.get(1).toString()) > sumRate/mvnum){ //大于平均推荐度的对象才有可能被推荐
